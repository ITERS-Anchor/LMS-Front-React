...
class StudentDetails extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (this.props.match.params.id === 'create') {
      axios.post('/api/students/createstudent', student)
        .then(onSuccess)
        .catch(onError);
    } else {
      axios.put('/api/students/updatestudent', student)
        .then(onSuccess)
        .catch(onError);
    }
  }
    ...
    return (
      <Segment style={{ width: 600, margin: '0 auto' }}>
        ...
        <form className="ui form" onSubmit={this.handleSubmit.bind(this)}>
          ...
          <button
            className={classnames('ui blue button', { loading: this.state.isSaving })}
            type="submit"
